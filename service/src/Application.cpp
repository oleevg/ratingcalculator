...
namespace rating_calculator {
  ...
  namespace service {
    ...
    void Application::parseArguments(int argc, const char** argv)
    {
      ...
      const std::size_t threadPoolSizeDefault = 5;
      ...
      std::size_t threadPoolSize = threadPoolSizeDefault;
      ...
      optionDescription.add_options()("port,p", options::value<int>(&port)->default_value(portDefault),
          ...
          "threads", options::value<std::size_t>(&threadPoolSize)->default_value(threadPoolSizeDefault),
