...
namespace rating_calculator {
  ...
  namespace core {
     ...
     */
    template <class T> class EnumConverter : public boost::serialization::singleton<EnumConverter<T>> {
    ...
    public:
      using EnumToString = std::map<T, std::string>;
      using StringToEnum = std::map<std::string, T, StringInCaseLess>;
