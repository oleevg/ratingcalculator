...
BOOST_AUTO_TEST_CASE(Should_get_previous_week_day)
{
  ...
  auto timePoint = core::TimeHelper::getPreviousWeekDay(std::chrono::system_clock::from_time_t(timegm(&tmTime)),
                                                        core::TimeHelper::WeekDay::Monday);
...
BOOST_AUTO_TEST_CASE(Should_get_next_week_day)
{
  ...
  auto timePoint = core::TimeHelper::getNextWeekDay(std::chrono::system_clock::from_time_t(timegm(&tmTime)),
                                                    core::TimeHelper::WeekDay::Friday);
