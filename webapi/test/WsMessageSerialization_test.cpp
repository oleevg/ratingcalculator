...
template <class T> bool operator==(const transport::WsData& lhs, const transport::WsData& rhs)
{
  bool base = static_cast<const transport::WsMessage&>(lhs) == static_cast<const transport::WsMessage&>(rhs);
...
BOOST_AUTO_TEST_CASE(Serialize_Deserialize_equal_true)
{
  ...
  transport::WsData wsData(123,
                           std::make_shared<rating_calculator::core::Message<rating_calculator::core::UserInformation>>(
                               rating_calculator::core::MessageType::UserRegistered, 1234, "user"));
  ...
  transport::WsData wsDealInformation(
      124, std::make_shared<rating_calculator::core::Message<rating_calculator::core::DealInformation>>(
               rating_calculator::core::MessageType::UserDealWon, 1234, 777, 123.456));
